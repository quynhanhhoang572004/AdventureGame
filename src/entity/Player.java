...
//      projectile = new OBJ_Rock(gp);
    ...
    public void getPlayerAttackImage(){
        if(currentWeapon.type == type_sword){
            attackUp1 = setup("res/player/attack/FroGi_sword_up1", gp.tileSize, gp.tileSize*2);
            attackUp2 = setup("res/player/attack/FroGi_sword_up2", gp.tileSize, gp.tileSize*2);
            attackDown1 = setup("res/player/attack/FroGi_sword_down1", gp.tileSize, gp.tileSize*2);
        ...
        if(currentWeapon.type == type_axe){
            attackUp1 = setup("res/player/attack/FroGi_axe_down1", gp.tileSize, gp.tileSize*2);
            attackUp2 = setup("res/player/attack/FroGi_axe_down2", gp.tileSize, gp.tileSize*2);
            attackDown1 = setup("res/player/attack/FroGi_axe_front1", gp.tileSize, gp.tileSize*2);
